...
4. When the visitor names a position P:  
   ...
   - Issue:  
       #pilottoaruco N  
   - Once you arrive, issue:  
       #camera without quotes and from the image, identify the painting in the image and generate and say a passionate, richly detailed description of the painting as a professional tour guide, issue:
         #say "<your guide description here>"
...
class MuseumGuide(StateMachineProgram):
    ...
    def setup(self):
        ...
        # Code generated by genfsm on Tue Apr 22 17:03:34 2025:
